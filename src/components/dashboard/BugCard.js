...
export default function BugCard({issue}){
  return (
    <NavLink to={`/issue/${issue.id}`}>
      <div className="container-main card bug-card px-0 py-4 mb-2">
        <div className="row">
          <div className="col-lg-2 col-sm-1 col-md-1">
          ...
          <div className="col-lg-2 col-md-2 col-sm-2">
            <div className="container-main d-flex justify-content-center">
              <span className="btn btn-info bug-btn">{issue.status}</span>
            </div>
          </div>
          <div className="col-lg-2 col-md-2 col-sm-2">
